...
if __name__=='__main__':
    ...
    tname=sys.argv[1]
    t=Table.read(tname)
    ot=Table.read('Flowchart_sources_COSMOS-HighRes-DoubleDetect-2023-05-04_fixed.fits')
    ...
    print('Reading data...')
    gals=Table.read('/beegfs/general/halec001/MIGHTEE/Catalogues/Ks-band/COSMOS/COSMOSFULL_DR3_UNMASKED_Ks_2023_03_11_2.0as_IRAC_2.8as_ALL_CH_prefilter.fits')
    gals['RA'].name='ra'
    gals['DEC'].name='dec'
    lofarfile=fits.open('/beegfs/general/halec001/MIGHTEE/Images/MeerKAT/COSMOS/MIGHTEE_Continuum_DR1_COSMOS_5p2arcsec_I_v1.fits')
    spitzerfile=fits.open('/beegfs/general/halec001/MIGHTEE/Images/3p6um-band/COSMOS/COSMOS_ch1_COMPLETE_microJy.fits')
    ibandfile=fits.open('/beegfs/general/halec001/MIGHTEE/Images/i-band/COSMOS/HSC-I_DR3.fits')
    marker_ra=None
    marker_dec=None
