...
if __name__=='__main__':
    ...
    ot=Table.read('Flowchart_sources_CDFS-DEEP-HighRes-DoubleDetect-2023-05-04_fixed.fits')
    ...
    print('Reading data...')
    gals=Table.read('/beegfs/general/halec001/MIGHTEE/Catalogues/Ks-band/CDFS/CDFSFULL_DR3_UNMASKED_Ks_2022_11_30_2.0as_IRAC_2.8as_ALL_CH_prefilter.fits')
    gals['RA'].name='ra'
    gals['DEC'].name='dec'
    lofarfile=fits.open('/beegfs/general/halec001/MIGHTEE/Images/MeerKAT/CDFS-DEEP/MIGHTEE_Continuum_DR1_CDFS-DEEP_5p5arcsec_I_v1.fits')
    spitzerfiles=[]
    spitzerwcs=[]
    ibandfiles=[]
    ibandwcs=[]
    for i in range(1,4):
        print(i)
        spitzerfiles.append(fits.open('/beegfs/general/halec001/MIGHTEE/Images/3p6um-band/CDFS-DEEP/cdfs%i_SERVS_ch1.fits' % i))
        spitzerwcs.append(WCS(spitzerfiles[-1][0].header))
        ibandfiles.append(fits.open('/beegfs/general/halec001/MIGHTEE/Images/i-band/CDFS-DEEP/CDFS%i_HSC-I.fits' % i))
